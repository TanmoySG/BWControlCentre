...
if (isset($_SESSION['logged_in'])) {
    ...
    if (isset($_POST['email'], $_POST['password'])) {
        ...
        if (empty($email) or empty($password)) {
            ...
            $query = "SELECT * FROM administrators WHERE name='$name' AND email='$email' AND password='$password'";
...
<html>
    ...
    <body style="background-color: #464646; ">
        ...
        <div style="padding-top: 25px">
            <div class="col-lg-offset-4 col-lg-4 box" style="vertical-align: middle; padding: 75px; background-color: #242424;">
                <form action = "login.php" method = "POST" style="color: #d1d1d1; "> 
                    ...
                    <div class="row form-input-group">
                        ...
                        <select name="name" class="input-box col-lg-12" style="background-color: transparent; color: white">
                    ...
                    <br>     
                    <div class="row form-input-group">
                        <button type="submit" name="submit" class="form-button-one col-lg-12" style="background-color: #8001ff; border-color:#8001ff; color: white">Log-In</button>
                    </div>               
                </form>  
            </div>
        </div>
